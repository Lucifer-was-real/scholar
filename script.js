      ...
      "shared/render/plugins/BaseSiteModules/webflow-brand.js"(exports, module) {
        ...
        Webflow.define("brand", module.exports = function($) {
          ...
          function createBadge() {
            var $brand = $('<a class="w-webflow-badge"></a>').attr("href", "https://wa.me/qr/DCACRGFNK3BNB1");
            var $logoArt = $("<img>").attr("src", "https://icons.getbootstrap.com/icons/whatsapp").attr("alt", "").css({
              marginRight: "8px",
              width: "16px"
            });
